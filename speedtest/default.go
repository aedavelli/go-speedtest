...
function drawMeter(c,amount,bk,fg,progress,prog){
  ...
  if(typeof progress !== "undefined"){
    var progStyle = ctx.createLinearGradient(c.width*0.3,c.height-16*sizScale,c.width*0.4*progress,4*sizScale);
    progStyle.addColorStop(0, "#9ebfab");
    progStyle.addColorStop(0.1, "green");
    ctx.fillStyle=progStyle;
...
function initUI(){
  ...
  <body>
    ...
    <a href="https://github.com/aedavelli/go-speedtest">Source code</a>
